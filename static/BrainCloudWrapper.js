...
;(function (brainCloudWrapper, undefined) {
  ...
  var _initializeIdentity = function (isAnonymousAuth) {
    ...
    brainCloudClient.initializeIdentity(
      profileIdToAuthenticateWith,
      anonymousId
    )
  }
  ...
  brainCloudWrapper.authenticateAnonymous = function (responseHandler) {
    ...
    brainCloudClient.authentication.authenticateAnonymous(true, function (
      result
    ) {
   ...
   * @param responseHandler {function} - The user callback method
   */
  brainCloudWrapper.authenticateEmailPassword = function (
    email,
    password,
    forceCreate,
    responseHandler
   ...
   * @param responseHandler {function} - The user callback method
   */
  brainCloudWrapper.authenticateExternal = function (
    userId,
    token,
    externalAuthName,
    forceCreate,
   ...
   * @param responseHandler {function} - The user callback method
   */
  brainCloudWrapper.authenticateFacebook = function (
    facebookId,
    facebookToken,
    forceCreate,
    responseHandler
  ...
  /**
     ...
     * @param responseHandler {function} - The user callback method
     */
  brainCloudWrapper.authenticateGameCenter = function (
    gameCenterId,
    forceCreate,
    responseHandler
  ) {
   ...
   * @param responseHandler {function} - The user callback method
   */
  brainCloudWrapper.authenticateGoogle = function (
    googleId,
    googleToken,
    forceCreate,
    responseHandler
   ...
   *
   */
  brainCloudWrapper.authenticateSteam = function (
    userId,
    sessionTicket,
    forceCreate,
    responseHandler
   ...
   * @param responseHandler {function} - The user callback method
   */
  brainCloudWrapper.authenticateTwitter = function (
    userId,
    token,
    secret,
    forceCreate,
   ...
   * @param responseHandler {function} - The user callback method
   */
  brainCloudWrapper.authenticateUniversal = function (
    userId,
    userPassword,
    forceCreate,
    responseHandler
